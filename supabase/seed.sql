...
INSERT INTO public.profiles (email, full_name, role, department, phone, ssn_last_four, salary, notes, is_seed) VALUES
('admin@hackable.test', 'Sarah Chen', 'admin', 'Engineering', '(555) 100-0001', '4521', '$195,000', 'FLAG{idor_admin_data_exposed} - System administrator. Has access to all internal systems including AWS console, Stripe dashboard, and Supabase admin panel.', TRUE);

-- Employees
INSERT INTO public.profiles (email, full_name, role, department, phone, ssn_last_four, salary, notes, is_seed) VALUES
('marcus.johnson@hackable.test', 'Marcus Johnson', 'manager', 'Engineering', '(555) 100-0002', '8834', '$145,000', 'Engineering manager. Leads the platform team. Joined March 2021.', TRUE),
('priya.patel@hackable.test', 'Priya Patel', 'employee', 'Engineering', '(555) 100-0003', '2297', '$132,000', 'Senior backend engineer. Owns the auth service and payment integrations.', TRUE),
('james.oconnor@hackable.test', 'James O''Connor', 'employee', 'Sales', '(555) 100-0004', '6610', '$95,000', 'Account executive, enterprise segment. Exceeded Q1 quota by 18%.', TRUE),
('aisha.williams@hackable.test', 'Aisha Williams', 'manager', 'Marketing', '(555) 100-0005', '3378', '$125,000', 'Director of growth marketing. Previously at Datadog and Twilio.', TRUE),
('david.kim@hackable.test', 'David Kim', 'employee', 'Finance', '(555) 100-0006', '9142', '$110,000', 'Financial analyst. Manages the monthly burn-rate reporting and board deck financials.', TRUE),
('rachel.torres@hackable.test', 'Rachel Torres', 'employee', 'HR', '(555) 100-0007', '5563', '$88,000', 'HR generalist. Handles onboarding, benefits administration, and employee relations.', TRUE),
('alex.nakamura@hackable.test', 'Alex Nakamura', 'employee', 'Engineering', '(555) 100-0008', '7205', '$128,000', 'Frontend engineer. Building the new React dashboard. On-call this week.', TRUE);

-- ============================================================
-- POSTS
-- ============================================================

INSERT INTO public.posts (author_id, title, content, category, created_at, is_seed) VALUES
...
If you have concerns or dependencies, drop a comment or ping me on Slack. I''ll send calendar invites for the weekly sync starting next Monday.',
 'engineering', '2026-03-15 09:30:00+00', TRUE),
...
(1, 'Office Hours Changing Starting April 14',
 ...
 'general', '2026-03-20 14:00:00+00', TRUE),
...
(5, 'Welcome Our New Marketing Coordinator!',
 ...
 'general', '2026-03-22 11:15:00+00', TRUE),
...
No action needed from most teams. If you have batch jobs that depend on the auth API, please reschedule them outside this window. Reach out to #platform-eng with questions.',
 'engineering', '2026-03-25 16:45:00+00', TRUE),
...
Full notes in Confluence — search for "Q1 2026 Retro."',
 'engineering', '2026-04-01 10:00:00+00', TRUE),
...
I''ll be putting together a custom demo for next week. If anyone from Engineering can join to answer technical questions about our API and SSO integration, that would be huge. Ping me on Slack.',
 'sales', '2026-04-02 13:20:00+00', TRUE),
...
Full breakdown will be in the board deck I''m circulating Thursday. Managers — please submit any expense recharges by EOD Wednesday.',
 'finance', '2026-04-03 09:00:00+00', TRUE),
...
Log into Rippling to review your current elections and make changes. If you have questions, I have office hours Tuesday and Thursday 2-3 PM, or email me directly.',
 'general', '2026-04-04 08:30:00+00', TRUE),
...
Next up: tackling the search page, which is still pretty sluggish on large datasets. Props to Priya for the backend query optimizations that made the API response times possible.',
 'engineering', '2026-04-07 11:00:00+00', TRUE),
...
Please submit questions in advance via the #all-hands Slack channel. Recording will be posted to Confluence afterward as usual.',
 'general', '2026-04-07 15:00:00+00', TRUE),
...
This is to address some abuse we''ve been seeing from a handful of free-tier accounts hammering the search endpoint. If any of your integration partners will be affected, please give them a heads-up. Full docs update will go out next week.',
 'engineering', '2026-04-08 14:30:00+00', TRUE),
...
Writers: please have first drafts in by the dates marked in Asana. Design requests should go to #creative with at least 5 business days lead time.',
 'marketing', '2026-04-09 10:00:00+00', TRUE),
...
The branch preview feature means every PR now gets its own URL at preview-{branch}.nexusdynamics.dev. This should make QA reviews much smoother. Let me know if you hit any issues.',
 'engineering', '2026-04-10 09:15:00+00', TRUE);

-- ============================================================
-- MESSAGES
-- ============================================================

INSERT INTO public.messages (sender_id, recipient_id, content, created_at, is_seed) VALUES
(2, 1, 'Hey Sarah, the Next.js migration is on track but I might need to pull Alex off the dashboard optimization to help with the routing layer. Can we sync tomorrow?', '2026-04-01 10:30:00+00', TRUE),
(1, 2, 'Sure, let''s do 11 AM. I also want to discuss the new hire req for the platform team — got budget approval yesterday.', '2026-04-01 10:45:00+00', TRUE),
(4, 5, 'Aisha, the GlobalTech demo is next Wednesday. Can your team put together a one-pager on our enterprise features? They''re specifically interested in the SSO and audit log capabilities.', '2026-04-03 14:00:00+00', TRUE),
(5, 4, 'On it — I''ll have the collateral ready by Monday. Can you share the discovery call notes so I can tailor the messaging?', '2026-04-03 14:20:00+00', TRUE),
(7, 1, 'Sarah, just a heads-up: we''re getting close to the open enrollment deadline and only 60% of employees have reviewed their elections. Mind sending a reminder at the all-hands?', '2026-04-07 09:00:00+00', TRUE),
(1, 7, 'Good call, I''ll mention it Thursday. Can you also send a Slack reminder to anyone who hasn''t logged into Rippling yet?', '2026-04-07 09:15:00+00', TRUE),
(3, 8, 'Nice work on the dashboard perf improvements! The backend query caching I pushed last week should help even more once you wire up the new endpoints. Want to pair on it Friday?', '2026-04-07 16:00:00+00', TRUE),
(8, 3, 'Absolutely, let''s do it. I''ll block off 2-4 PM. Also — have you seen the search page latency? It''s brutal on large result sets. Might need your help optimizing that query.', '2026-04-07 16:30:00+00', TRUE);
